namespace LibraryManagement
{
    partial class AddMemberForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            // 
            email.AutoSize = true;
            email.Font = new Font("Segoe UI Semibold", 10.8F, FontStyle.Bold, GraphicsUnit.Point, 0);
            email.Location = new Point(31, 135);
            email.Name = "email";
            email.Size = new Size(56, 25);
            email.TabIndex = 4;
            email.Text = "Email";
            // 
            // Password
            ...
            // 
            name.AutoSize = true;
            name.Font = new Font("Segoe UI Semibold", 10.8F, FontStyle.Bold, GraphicsUnit.Point, 0);
            name.Location = new Point(30, 68);
            name.Name = "name";
            name.Size = new Size(61, 25);
            name.TabIndex = 7;
            name.Text = "Name";
